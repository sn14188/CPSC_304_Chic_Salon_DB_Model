...
<body>
    ...
    <script>
        document.getElementById('tableSelectForm').addEventListener('submit', function (event) {
            ...
            //switch case to Redirect the user to the corresponding PHP page based on the selected option

            switch(selectedTable){
                case 'All Services':
                    window.location.href = 'Services/AllServices.php';
                    break;
                case 'Style':
                    window.location.href = 'Services/Style.php';
                    break;
                case 'Cut':
                    window.location.href = 'Services/Cut.php';
                    break;
                case 'Color':
                    window.location.href = 'Services/Color.php';
                    break;
            }
        });
    </script>
