...
<h2>Display Information</h2>
    ...
    {
        echo "<br>Retrieved data from table Coloring:<br>";
        echo "<table>";
        echo "<tr><th>serviceID</th><th>color</th></tr>";
        while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
            echo "<tr><td>" . $row["SERVICEID"] . "</td><td>" . $row["COLOR"] . "</td></tr>";
        }
        echo "</table>";
    }
    ...
    function handleInsertRequest()
    {
        ...
        executeBoundSQL("INSERT INTO Coloring VALUES (:bind1, :bind2)", $alltuples);
    ...
    function handleGETRequest()
    {
        if (connectToDB()) {
            if (array_key_exists('countTuples', $_GET)) {
                ...
                handlePrintTableRequest('Coloring');
...
<hr>
    <h2>Managing Coloring</h2>
    <h3>Insert Coloring Values - price & duration will respectively be added to Service table</h3>
