...
{
    echo "<br>Retrieved data from table Styling:<br>";
    echo "<table>";
    echo "<tr><th>serviceID</th><th>hairDry</th><th>curling</th><th>straightening</th></tr>";
    while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
        echo "<tr><td>" . $row["SERVICEID"] . "</td><td>" . $row["HAIRDRY"] . "</td><td>" . $row["CURLING"] . "</td><td>" . $row["STRAIGHTENING"] . "</td></tr>";
    }
    echo "</table>";
}
...
function handleInsertRequest()
{
    ...
    $tuple = array(
        ...
        ":bind2" => $_POST['hairDry'],
        ":bind3" => $_POST['curling'],
        ":bind4" => $_POST['straightening'],
        ":bind5" => $_POST['price'],
        ":bind6" => $_POST['duration']
    );

    $alltuples = array($tuple);

    executeBoundSQL("INSERT INTO Service VALUES (:bind1, :bind5, :bind6)", $alltuples);
    executeBoundSQL("INSERT INTO Styling VALUES (:bind1, :bind2, :bind3, :bind4)", $alltuples);
...
function handleGETRequest()
{
    if (connectToDB()) {
        if (array_key_exists('countTuples', $_GET)) {
            ...
            handlePrintTableRequest('Styling');
...
?>
    <hr>
    <h2>Managing Styling</h2>
    <h3>Insert Styling Values - price & duration will respectively be added to Service table</h3>
    <form method="POST" action="Style.php">
        <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
        serviceID: <input type="text" name="serviceID"> <br /><br />
        hairDry: <input type="text" name="hairDry"> <br /><br />
        curling: <input type="text" name="curling"> <br /><br />
        straightening: <input type="text" name="straightening"> <br /><br />
